...
contains
  subroutine fex(neq,tt,nin,dy)
    ...
    n(1,patmo_idx_H2O) = 3.38d17 !number density converted from mixing ratio 0.015 H2O Pinto (1980)  
    ! Wet Deposition
    do j=12, 2, -1
      do i = 1, chemSpeciesNumber
    ...
    do j=12, 2, -1
      dn(j,patmo_idx_CH2O) = dn(j,patmo_idx_CH2O) - 2.8d3 !Pinto 1980 HCHO wet deposition rate =1d11 moles/yr (2.8d8/1km (molecules/s/cm3))
      dn(j - 1, patmo_idx_CH2O) = dn(j - 1, patmo_idx_CH2O) +  2.8d3
    end do
    dn(1,patmo_idx_CH2O) = dn(1,patmo_idx_CH2O) - 2.8d3
