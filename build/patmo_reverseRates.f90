  ...
  subroutine computeReverseRates(inTgas)
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,245) = krate(i,1)*exp(3.543341d0*(lnTgas(i)-1d0) &
            - 4.164922d-3*Tgas(i) &
            + 4.402935d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,245) = krate(i,1)*exp(-6.125694d0*(lnTgas(i)-1d0) &
            + 6.280764d-3*Tgas(i) &
            - 1.355459d-6*Tgas2(i) &
            + 1.4979d-10*Tgas3(i) &
      ...
      krate(i,245) = krate(i,245) / ntot(i)
    end do

    !O2 + O2 -> O + O3
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,246) = krate(i,2)*exp(-9.892634d-1*(lnTgas(i)-1d0) &
            + 2.38397d-3*Tgas(i) &
            + 1.328442d-7*Tgas2(i) &
            ...
            + 3.019058d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,246) = krate(i,2)*exp(7.552007d0*(lnTgas(i)-1d0) &
            - 6.636263d-3*Tgas(i) &
            + 1.377587d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,247) = krate(i,3)*exp(-1.657593d0*(lnTgas(i)-1d0) &
            + 4.023715d-3*Tgas(i) &
            - 9.743907d-7*Tgas2(i) &
            ...
            + 5.58397d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,247) = krate(i,3)*exp(7.502055d0*(lnTgas(i)-1d0) &
            - 6.615724d-3*Tgas(i) &
            + 1.376612d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,248) = krate(i,4)*exp(-4.21167d0*(lnTgas(i)-1d0) &
            + 5.804667d-3*Tgas(i) &
            - 1.547528d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,248) = krate(i,4)*exp(6.075742d0*(lnTgas(i)-1d0) &
            - 6.260225d-3*Tgas(i) &
            + 1.354484d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,249) = krate(i,5)*exp(-6.683292d-1*(lnTgas(i)-1d0) &
            + 1.639745d-3*Tgas(i) &
            - 1.107235d-6*Tgas2(i) &
            ...
            + 2.564912d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,249) = krate(i,5)*exp(-4.995222d-2*(lnTgas(i)-1d0) &
            + 2.053902d-5*Tgas(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,250) = krate(i,6)*exp(-6.683292d-1*(lnTgas(i)-1d0) &
            + 1.639745d-3*Tgas(i) &
            - 1.107235d-6*Tgas2(i) &
            + 5.107031d-10*Tgas3(i) &
            - 1.056415d-13*Tgas4(i) &
            ...
            + 2.564912d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,250) = krate(i,6)*exp(-4.995222d-2*(lnTgas(i)-1d0) &
            + 2.053902d-5*Tgas(i) &
            - 9.749684d-10*Tgas2(i) &
            - 1.828914d-13*Tgas3(i) &
            + 1.389781d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,251) = krate(i,7)*exp(-6.84888d-1*(lnTgas(i)-1d0) &
            + 3.69929d-3*Tgas(i) &
            - 2.090058d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,251) = krate(i,7)*exp(7.335574d0*(lnTgas(i)-1d0) &
            - 6.681304d-3*Tgas(i) &
            + 1.363473d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,252) = krate(i,8)*exp(-3.847717d0*(lnTgas(i)-1d0) &
            + 2.849602d-3*Tgas(i) &
            + 1.782609d-6*Tgas2(i) &
            - 1.947149d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,252) = krate(i,8)*exp(6.342127d0*(lnTgas(i)-1d0) &
            - 6.235723d-3*Tgas(i) &
            + 1.369572d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,253) = krate(i,9)*exp(3.126908d-1*(lnTgas(i)-1d0) &
            - 1.058526d-3*Tgas(i) &
            + 1.567881d-6*Tgas2(i) &
            - 1.082194d-9*Tgas3(i) &
            ...
            + 8.03997d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,253) = krate(i,9)*exp(6.728182d-1*(lnTgas(i)-1d0) &
            - 3.204791d-4*Tgas(i) &
            + 4.57735d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,254) = krate(i,10)*exp(-1.285395d0*(lnTgas(i)-1d0) &
            + 1.382952d-3*Tgas(i) &
            - 4.52214d-7*Tgas2(i) &
            ...
            + 3.975833d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,254) = krate(i,10)*exp(-5.06337d-1*(lnTgas(i)-1d0) &
            + 3.860588d-4*Tgas(i) &
            - 3.263476d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,255) = krate(i,11)*exp(3.773793d0*(lnTgas(i)-1d0) &
            - 5.714109d-3*Tgas(i) &
            + 2.194662d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,255) = krate(i,11)*exp(6.231882d-1*(lnTgas(i)-1d0) &
            - 6.081815d-4*Tgas(i) &
            + 7.597284d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,256) = krate(i,12)*exp(-2.556374d0*(lnTgas(i)-1d0) &
            + 7.212648d-3*Tgas(i) &
            - 3.835994d-6*Tgas2(i) &
            + 1.410695d-9*Tgas3(i) &
            ...
            + 8.749691d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,256) = krate(i,12)*exp(7.032206d-1*(lnTgas(i)-1d0) &
            + 2.937603d-4*Tgas(i) &
            - 5.57946d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,257) = krate(i,13)*exp(-3.68011d0*(lnTgas(i)-1d0) &
            + 1.029233d-2*Tgas(i) &
            - 5.960046d-6*Tgas2(i) &
            + 2.363622d-9*Tgas3(i) &
            ...
            + 1.081362d1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,257) = krate(i,13)*exp(7.95333d-1*(lnTgas(i)-1d0) &
            + 1.293821d-4*Tgas(i) &
            - 1.838392d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,258) = krate(i,14)*exp(-8.88757d-1*(lnTgas(i)-1d0) &
            + 1.385934d-3*Tgas(i) &
            + 4.015448d-7*Tgas2(i) &
            ...
            + 2.42564d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,258) = krate(i,14)*exp(5.06718d-1*(lnTgas(i)-1d0) &
            + 1.48851d-4*Tgas(i) &
            - 4.366452d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,259) = krate(i,15)*exp(-1.005064d-1*(lnTgas(i)-1d0) &
            + 9.980363d-4*Tgas(i) &
            - 2.687007d-7*Tgas2(i) &
            - 1.26249d-10*Tgas3(i) &
            ...
            + 5.934182d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,259) = krate(i,15)*exp(7.045289d0*(lnTgas(i)-1d0) &
            - 6.785114d-3*Tgas(i) &
            + 1.421251d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,260) = krate(i,16)*exp(1.395364d0*(lnTgas(i)-1d0) &
            - 3.512586d-3*Tgas(i) &
            + 1.601975d-6*Tgas2(i) &
            ...
            - 3.665417d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,260) = krate(i,16)*exp(6.070608d0*(lnTgas(i)-1d0) &
            - 6.497085d-3*Tgas(i) &
            + 1.384992d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,261) = krate(i,17)*exp(2.42995d0*(lnTgas(i)-1d0) &
            - 1.515362d-2*Tgas(i) &
            + 1.384701d-5*Tgas2(i) &
            - 7.55345d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,261) = krate(i,17)*exp(-7.425733d-1*(lnTgas(i)-1d0) &
            - 6.212383d-5*Tgas(i) &
            + 6.326582d-9*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,261) = krate(i,261) / ntot(i)
    end do

    !HNO3 -> NO2 + OH
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,262) = krate(i,18)*exp(6.242724d0*(lnTgas(i)-1d0) &
            - 1.150163d-2*Tgas(i) &
            + 4.921037d-6*Tgas2(i) &
            - 1.524454d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,262) = krate(i,18)*exp(-3.077051d-1*(lnTgas(i)-1d0) &
            - 5.948887d-4*Tgas(i) &
            + 1.004209d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,262) = krate(i,262) / ntot(i)
    end do

    !NO3 + H2O -> HNO3 + OH
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,263) = krate(i,19)*exp(-6.869527d-1*(lnTgas(i)-1d0) &
            + 4.080918d-3*Tgas(i) &
            - 3.533789d-6*Tgas2(i) &
            + 1.975318d-9*Tgas3(i) &
            - 4.7074d-13*Tgas4(i) &
            ...
            + 3.326785d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,263) = krate(i,19)*exp(7.090038d-1*(lnTgas(i)-1d0) &
            + 1.304827d-5*Tgas(i) &
            - 3.922799d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,263) = krate(i,263) / ntot(i)
    end do

    !OH + NO2 -> HO2 + NO
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,264) = krate(i,20)*exp(5.843816d-1*(lnTgas(i)-1d0) &
            - 2.701253d-3*Tgas(i) &
            + 1.821357d-6*Tgas2(i) &
            ...
            - 2.107212d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,264) = krate(i,20)*exp(-2.902846d-1*(lnTgas(i)-1d0) &
            - 1.038104d-4*Tgas(i) &
            + 5.777823d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,265) = krate(i,21)*exp(-1.867058d0*(lnTgas(i)-1d0) &
            + 3.725796d-3*Tgas(i) &
            - 1.025562d-7*Tgas2(i) &
            ...
            + 4.282116d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,265) = krate(i,21)*exp(8.3308d0*(lnTgas(i)-1d0) &
            - 6.848129d-3*Tgas(i) &
            + 1.40376d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,266) = krate(i,22)*exp(8.77795d-1*(lnTgas(i)-1d0) &
            - 1.341826d-3*Tgas(i) &
            + 2.354004d-7*Tgas2(i) &
            ...
            - 1.263058d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,266) = krate(i,22)*exp(-7.787933d-1*(lnTgas(i)-1d0) &
            + 2.118654d-4*Tgas(i) &
            - 2.617348d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,267) = krate(i,23)*exp(1.980658d0*(lnTgas(i)-1d0) &
            + 8.761934d-4*Tgas(i) &
            - 1.885165d-6*Tgas2(i) &
            + 1.216258d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,267) = krate(i,23)*exp(1.988673d0*(lnTgas(i)-1d0) &
            - 6.124052d-4*Tgas(i) &
            + 3.418794d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,267) = krate(i,267) / ntot(i)
    end do

    !OH + O2 -> O + HO2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,268) = krate(i,24)*exp(-3.043754d-1*(lnTgas(i)-1d0) &
            - 1.31532d-3*Tgas(i) &
            + 2.222902d-6*Tgas2(i) &
            - 1.403667d-9*Tgas3(i) &
            ...
            + 2.214918d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,268) = krate(i,24)*exp(2.164334d-1*(lnTgas(i)-1d0) &
            + 4.504066d-5*Tgas(i) &
            + 1.411371d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,269) = krate(i,25)*exp(-1.18217d0*(lnTgas(i)-1d0) &
            + 2.650606d-5*Tgas(i) &
            + 1.987502d-6*Tgas2(i) &
            - 1.376505d-9*Tgas3(i) &
            ...
            + 3.477976d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,269) = krate(i,25)*exp(9.952267d-1*(lnTgas(i)-1d0) &
            - 1.668248d-4*Tgas(i) &
            + 4.028719d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,270) = krate(i,26)*exp(-5.651042d-1*(lnTgas(i)-1d0) &
            + 2.832998d-4*Tgas(i) &
            + 1.332481d-6*Tgas2(i) &
            - 1.055033d-9*Tgas3(i) &
            ...
            + 2.067055d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,270) = krate(i,26)*exp(1.451612d0*(lnTgas(i)-1d0) &
            - 5.323445d-4*Tgas(i) &
            + 7.194698d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,271) = krate(i,27)*exp(6.750106d-1*(lnTgas(i)-1d0) &
            - 4.866454d-3*Tgas(i) &
            + 5.131523d-6*Tgas2(i) &
            - 2.896025d-9*Tgas3(i) &
            ...
            - 1.070707d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,271) = krate(i,27)*exp(7.846101d-2*(lnTgas(i)-1d0) &
            + 1.991012d-4*Tgas(i) &
            - 9.787549d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,272) = krate(i,28)*exp(1.284427d0*(lnTgas(i)-1d0) &
            - 8.095752d-3*Tgas(i) &
            + 7.002142d-6*Tgas2(i) &
            - 3.414031d-9*Tgas3(i) &
            ...
            - 5.561752d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,272) = krate(i,28)*exp(-9.048432d-1*(lnTgas(i)-1d0) &
            + 9.695294d-4*Tgas(i) &
            - 1.54755d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,273) = krate(i,29)*exp(2.467941d0*(lnTgas(i)-1d0) &
            + 2.211715d-3*Tgas(i) &
            - 5.404621d-6*Tgas2(i) &
            + 3.450597d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,273) = krate(i,29)*exp(1.083776d0*(lnTgas(i)-1d0) &
            - 1.334072d-3*Tgas(i) &
            + 1.869645d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,273) = krate(i,273) / ntot(i)
    end do

    !CH3OOH + O2 -> CH3O2 + HO2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,274) = krate(i,30)*exp(2.585628d0*(lnTgas(i)-1d0) &
            - 1.227271d-2*Tgas(i) &
            + 8.960328d-6*Tgas2(i) &
            - 3.918244d-9*Tgas3(i) &
            + 7.41685d-13*Tgas4(i) &
            ...
            - 8.5002d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,274) = krate(i,30)*exp(-1.698749d0*(lnTgas(i)-1d0) &
            + 8.660874d-4*Tgas(i) &
            - 7.726249d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,275) = krate(i,31)*exp(1.534458d0*(lnTgas(i)-1d0) &
            - 2.771692d-3*Tgas(i) &
            + 7.441351d-7*Tgas2(i) &
            ...
            - 7.788779d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,275) = krate(i,31)*exp(-8.265292d-1*(lnTgas(i)-1d0) &
            + 3.497762d-4*Tgas(i) &
            - 2.375307d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,276) = krate(i,32)*exp(-6.086949d0*(lnTgas(i)-1d0) &
            + 1.47221d-2*Tgas(i) &
            - 6.426651d-6*Tgas2(i) &
            + 1.511144d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,276) = krate(i,32)*exp(1.918815d0*(lnTgas(i)-1d0) &
            - 2.75695d-4*Tgas(i) &
            + 7.3772d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,277) = krate(i,33)*exp(-2.272937d0*(lnTgas(i)-1d0) &
            + 1.121419d-2*Tgas(i) &
            - 7.392447d-6*Tgas2(i) &
            + 2.83605d-9*Tgas3(i) &
            ...
            + 9.304197d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,277) = krate(i,33)*exp(2.371567d0*(lnTgas(i)-1d0) &
            - 1.186566d-3*Tgas(i) &
            + 1.23036d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,278) = krate(i,34)*exp(-1.60126d0*(lnTgas(i)-1d0) &
            + 4.428043d-3*Tgas(i) &
            - 1.829648d-6*Tgas2(i) &
            ...
            + 5.910624d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,278) = krate(i,34)*exp(1.076939d0*(lnTgas(i)-1d0) &
            + 1.170434d-5*Tgas(i) &
            - 4.022674d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,279) = krate(i,35)*exp(3.495261d-1*(lnTgas(i)-1d0) &
            - 3.476123d-3*Tgas(i) &
            + 3.569212d-6*Tgas2(i) &
            - 1.90798d-9*Tgas3(i) &
            ...
            - 1.96054d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,279) = krate(i,35)*exp(-5.889973d-1*(lnTgas(i)-1d0) &
            + 9.023218d-4*Tgas(i) &
            - 1.832985d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,280) = krate(i,36)*exp(1.386709d-1*(lnTgas(i)-1d0) &
            - 4.79006d-4*Tgas(i) &
            + 2.792039d-7*Tgas2(i) &
            ...
            - 2.590471d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,280) = krate(i,36)*exp(3.602028d-1*(lnTgas(i)-1d0) &
            - 2.687266d-5*Tgas(i) &
            + 3.319591d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,281) = krate(i,37)*exp(2.714705d0*(lnTgas(i)-1d0) &
            - 5.997775d-3*Tgas(i) &
            + 2.12592d-6*Tgas2(i) &
            ...
            - 6.04981d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,281) = krate(i,37)*exp(-1.249495d0*(lnTgas(i)-1d0) &
            - 1.41158d-4*Tgas(i) &
            + 3.601722d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,281) = krate(i,281) / ntot(i)
    end do

    !H2O2 + O2 -> HO2 + HO2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,282) = krate(i,38)*exp(5.059883d-1*(lnTgas(i)-1d0) &
            - 2.827059d-3*Tgas(i) &
            + 2.471474d-6*Tgas2(i) &
            - 1.349599d-9*Tgas3(i) &
            ...
            + 5.019155d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,282) = krate(i,38)*exp(1.038411d-1*(lnTgas(i)-1d0) &
            - 4.736367d-4*Tgas(i) &
            + 1.245071d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,282) = krate(i,282) / ntot(i)
    end do

    !HO2 + H2O -> H2O2 + OH
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,283) = krate(i,39)*exp(-1.932975d-1*(lnTgas(i)-1d0) &
            + 1.768533d-3*Tgas(i) &
            - 9.035932d-7*Tgas2(i) &
            ...
            + 3.020815d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,283) = krate(i,39)*exp(5.689771d-1*(lnTgas(i)-1d0) &
            + 1.531575d-4*Tgas(i) &
            - 7.873356d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,284) = krate(i,40)*exp(-2.775076d-1*(lnTgas(i)-1d0) &
            + 1.258706d-3*Tgas(i) &
            - 4.510004d-7*Tgas2(i) &
            ...
            + 1.658291d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,284) = krate(i,40)*exp(5.450499d-1*(lnTgas(i)-1d0) &
            - 3.939921d-4*Tgas(i) &
            + 5.516733d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,285) = krate(i,41)*exp(-2.257872d0*(lnTgas(i)-1d0) &
            + 8.400735d-3*Tgas(i) &
            - 5.554705d-6*Tgas2(i) &
            + 2.47746d-9*Tgas3(i) &
            ...
            + 5.859493d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,285) = krate(i,41)*exp(9.007697d-1*(lnTgas(i)-1d0) &
            + 1.738856d-4*Tgas(i) &
            - 5.041413d-8*Tgas2(i) &
            + 5.80007d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,286) = krate(i,42)*exp(7.076339d-1*(lnTgas(i)-1d0) &
            - 2.334753d-3*Tgas(i) &
            + 2.330059d-6*Tgas2(i) &
            - 1.405889d-9*Tgas3(i) &
            ...
            - 3.82013d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,286) = krate(i,42)*exp(3.814896d-1*(lnTgas(i)-1d0) &
            - 2.809352d-4*Tgas(i) &
            + 3.560127d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,287) = krate(i,43)*exp(-2.009268d0*(lnTgas(i)-1d0) &
            + 1.01334d-2*Tgas(i) &
            - 8.049007d-6*Tgas2(i) &
            + 4.063298d-9*Tgas3(i) &
            ...
            + 3.121036d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,287) = krate(i,43)*exp(7.541485d-1*(lnTgas(i)-1d0) &
            + 2.786439d-4*Tgas(i) &
            - 7.387907d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,288) = krate(i,44)*exp(2.573447d0*(lnTgas(i)-1d0) &
            - 9.982074d-3*Tgas(i) &
            + 7.16588d-6*Tgas2(i) &
            - 3.355992d-9*Tgas3(i) &
            ...
            - 7.526717d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,288) = krate(i,44)*exp(-4.876406d-1*(lnTgas(i)-1d0) &
            - 3.447248d-4*Tgas(i) &
            + 6.608958d-8*Tgas2(i) &
            - 7.10943d-12*Tgas3(i) &
            + 3.52615d-16*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,289) = krate(i,45)*exp(1.584184d0*(lnTgas(i)-1d0) &
            - 7.598104d-3*Tgas(i) &
            + 7.298724d-6*Tgas2(i) &
            - 4.114045d-9*Tgas3(i) &
            ...
            - 4.507659d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,289) = krate(i,45)*exp(7.064366d0*(lnTgas(i)-1d0) &
            - 6.980988d-3*Tgas(i) &
            + 1.443677d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,290) = krate(i,46)*exp(1.002725d0*(lnTgas(i)-1d0) &
            - 5.273593d-3*Tgas(i) &
            + 5.386224d-6*Tgas2(i) &
            - 3.07128d-9*Tgas3(i) &
            ...
            - 2.970349d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,290) = krate(i,46)*exp(3.853828d-1*(lnTgas(i)-1d0) &
            - 6.850666d-5*Tgas(i) &
            - 2.520613d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,291) = krate(i,47)*exp(2.289248d-1*(lnTgas(i)-1d0) &
            - 2.744914d-3*Tgas(i) &
            + 3.195679d-6*Tgas2(i) &
            - 1.867226d-9*Tgas3(i) &
            ...
            + 2.589349d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,291) = krate(i,47)*exp(1.087555d-1*(lnTgas(i)-1d0) &
            + 2.368912d-4*Tgas(i) &
            - 5.712312d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,292) = krate(i,48)*exp(-3.881414d-1*(lnTgas(i)-1d0) &
            - 3.001707d-3*Tgas(i) &
            + 3.8507d-6*Tgas2(i) &
            - 2.188698d-9*Tgas3(i) &
            ...
            + 1.669856d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,292) = krate(i,48)*exp(-3.476293d-1*(lnTgas(i)-1d0) &
            + 6.02411d-4*Tgas(i) &
            - 8.878291d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,293) = krate(i,49)*exp(5.912447d-1*(lnTgas(i)-1d0) &
            - 6.552842d-3*Tgas(i) &
            + 6.759321d-6*Tgas2(i) &
            - 3.681057d-9*Tgas3(i) &
            + 8.29721d-13*Tgas4(i) &
            ...
            - 1.615769d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,293) = krate(i,49)*exp(-4.856017d-1*(lnTgas(i)-1d0) &
            + 7.564716d-4*Tgas(i) &
            - 1.126842d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,294) = krate(i,50)*exp(8.775649d-2*(lnTgas(i)-1d0) &
            - 4.496811d-4*Tgas(i) &
            + 3.892062d-7*Tgas2(i) &
            ...
            + 2.097107d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,294) = krate(i,50)*exp(1.268016d-1*(lnTgas(i)-1d0) &
            - 1.406198d-5*Tgas(i) &
            + 2.514851d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,295) = krate(i,51)*exp(7.343407d-1*(lnTgas(i)-1d0) &
            + 1.144254d-3*Tgas(i) &
            - 2.977785d-6*Tgas2(i) &
            + 2.086034d-9*Tgas3(i) &
            ...
            - 1.848608d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,295) = krate(i,51)*exp(-8.93775d-1*(lnTgas(i)-1d0) &
            + 4.267197d-4*Tgas(i) &
            - 6.956424d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,296) = krate(i,52)*exp(-1.434543d-1*(lnTgas(i)-1d0) &
            + 2.486079d-3*Tgas(i) &
            - 3.213186d-6*Tgas2(i) &
            + 2.113195d-9*Tgas3(i) &
            ...
            - 5.855506d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,296) = krate(i,52)*exp(-1.149817d-1*(lnTgas(i)-1d0) &
            + 2.148543d-4*Tgas(i) &
            - 4.339076d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,297) = krate(i,53)*exp(-8.260563d-1*(lnTgas(i)-1d0) &
            + 5.994522d-3*Tgas(i) &
            - 4.896531d-6*Tgas2(i) &
            + 2.362869d-9*Tgas3(i) &
            ...
            + 7.549152d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,297) = krate(i,53)*exp(7.35362d0*(lnTgas(i)-1d0) &
            - 6.932257d-3*Tgas(i) &
            + 1.445745d-6*Tgas2(i) &
            - 1.57388d-10*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,298) = krate(i,54)*exp(-7.255499d-1*(lnTgas(i)-1d0) &
            + 4.996486d-3*Tgas(i) &
            - 4.62783d-6*Tgas2(i) &
            + 2.489118d-9*Tgas3(i) &
            ...
            + 1.61497d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,298) = krate(i,54)*exp(3.083307d-1*(lnTgas(i)-1d0) &
            - 1.471428d-4*Tgas(i) &
            + 2.44934d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,299) = krate(i,55)*exp(-4.312865d-1*(lnTgas(i)-1d0) &
            + 2.22883d-4*Tgas(i) &
            + 1.19644d-6*Tgas2(i) &
            - 1.100242d-9*Tgas3(i) &
            ...
            + 3.021177d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,299) = krate(i,55)*exp(7.254038d0*(lnTgas(i)-1d0) &
            - 6.945426d-3*Tgas(i) &
            + 1.461383d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,300) = krate(i,56)*exp(5.579769d-1*(lnTgas(i)-1d0) &
            - 2.161087d-3*Tgas(i) &
            + 1.063596d-6*Tgas2(i) &
            ...
            + 2.11912d-3)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,300) = krate(i,56)*exp(-2.979689d-1*(lnTgas(i)-1d0) &
            - 3.091634d-4*Tgas(i) &
            + 8.379577d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,301) = krate(i,57)*exp(1.435772d0*(lnTgas(i)-1d0) &
            - 3.502913d-3*Tgas(i) &
            + 1.298996d-6*Tgas2(i) &
            ...
            - 1.260939d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,301) = krate(i,57)*exp(-1.076762d0*(lnTgas(i)-1d0) &
            - 9.729794d-5*Tgas(i) &
            + 5.762229d-8*Tgas2(i) &
            - 6.67916d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,302) = krate(i,58)*exp(-3.307801d-1*(lnTgas(i)-1d0) &
            - 7.751533d-4*Tgas(i) &
            + 1.465141d-6*Tgas2(i) &
            ...
            + 2.427759d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,302) = krate(i,58)*exp(2.087491d-1*(lnTgas(i)-1d0) &
            - 1.603123d-4*Tgas(i) &
            + 4.013125d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,303) = krate(i,59)*exp(-6.871497d-1*(lnTgas(i)-1d0) &
            + 3.692253d-3*Tgas(i) &
            - 3.775049d-6*Tgas2(i) &
            + 2.192748d-9*Tgas3(i) &
            ...
            + 1.303125d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,303) = krate(i,59)*exp(2.774641d-2*(lnTgas(i)-1d0) &
            - 1.023326d-4*Tgas(i) &
            + 1.819606d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,304) = krate(i,60)*exp(-1.676413d0*(lnTgas(i)-1d0) &
            + 6.076223d-3*Tgas(i) &
            - 3.642205d-6*Tgas2(i) &
            + 1.434695d-9*Tgas3(i) &
            ...
            + 4.322183d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,304) = krate(i,60)*exp(7.579753d0*(lnTgas(i)-1d0) &
            - 6.738596d-3*Tgas(i) &
            + 1.395783d-6*Tgas2(i) &
            - 1.51943d-10*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,305) = krate(i,61)*exp(1.906453d-1*(lnTgas(i)-1d0) &
            + 2.350427d-3*Tgas(i) &
            - 3.539649d-6*Tgas2(i) &
            + 2.165587d-9*Tgas3(i) &
            ...
            + 4.006756d-2)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,305) = krate(i,61)*exp(-7.510469d-1*(lnTgas(i)-1d0) &
            + 1.095328d-4*Tgas(i) &
            - 7.977419d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,306) = krate(i,62)*exp(1.61001d0*(lnTgas(i)-1d0) &
            - 8.009682d-3*Tgas(i) &
            + 6.273806d-6*Tgas2(i) &
            - 3.072642d-9*Tgas3(i) &
            ...
            - 1.31498d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,306) = krate(i,62)*exp(-5.787838d-1*(lnTgas(i)-1d0) &
            - 1.413477d-4*Tgas(i) &
            + 6.323959d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,307) = krate(i,63)*exp(1.025629d0*(lnTgas(i)-1d0) &
            - 5.308428d-3*Tgas(i) &
            + 4.452449d-6*Tgas2(i) &
            - 2.300779d-9*Tgas3(i) &
            ...
            - 1.104258d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,307) = krate(i,63)*exp(-2.884992d-1*(lnTgas(i)-1d0) &
            - 3.753731d-5*Tgas(i) &
            + 5.46136d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,308) = krate(i,64)*exp(9.251222d-1*(lnTgas(i)-1d0) &
            - 4.310392d-3*Tgas(i) &
            + 4.183748d-6*Tgas2(i) &
            - 2.427028d-9*Tgas3(i) &
            ...
            - 5.108402d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,308) = krate(i,64)*exp(6.75679d0*(lnTgas(i)-1d0) &
            - 6.822651d-3*Tgas(i) &
            + 1.426713d-6*Tgas2(i) &
            - 1.55403d-10*Tgas3(i) &
            + 6.59569d-15*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,309) = krate(i,65)*exp(2.513155d-1*(lnTgas(i)-1d0) &
            - 3.28556d-3*Tgas(i) &
            + 2.879785d-6*Tgas2(i) &
            - 1.349916d-9*Tgas3(i) &
            ...
            + 1.680711d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,309) = krate(i,65)*exp(-2.145633d-1*(lnTgas(i)-1d0) &
            + 2.016848d-4*Tgas(i) &
            - 2.77529d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,310) = krate(i,66)*exp(-3.706548d0*(lnTgas(i)-1d0) &
            + 5.543697d-4*Tgas(i) &
            + 4.589081d-6*Tgas2(i) &
            - 3.664404d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,310) = krate(i,66)*exp(6.324081d0*(lnTgas(i)-1d0) &
            - 5.98477d-3*Tgas(i) &
            + 1.287301d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,311) = krate(i,67)*exp(1.237552d-1*(lnTgas(i)-1d0) &
            - 4.973881d-3*Tgas(i) &
            + 4.997421d-6*Tgas2(i) &
            - 2.592509d-9*Tgas3(i) &
            ...
            - 1.89003d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,311) = krate(i,67)*exp(-4.243896d-1*(lnTgas(i)-1d0) &
            + 4.753954d-4*Tgas(i) &
            - 7.880742d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,312) = krate(i,68)*exp(-4.568213d-1*(lnTgas(i)-1d0) &
            + 4.389574d-3*Tgas(i) &
            - 3.938993d-6*Tgas2(i) &
            + 2.014456d-9*Tgas3(i) &
            - 4.35746d-13*Tgas4(i) &
            ...
            + 2.080435d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,312) = krate(i,68)*exp(5.001109d-1*(lnTgas(i)-1d0) &
            - 1.699002d-4*Tgas(i) &
            - 6.723714d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,313) = krate(i,69)*exp(2.907618d-1*(lnTgas(i)-1d0) &
            + 2.512911d-3*Tgas(i) &
            - 2.879387d-6*Tgas2(i) &
            + 1.644321d-9*Tgas3(i) &
            ...
            - 1.13614d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,313) = krate(i,69)*exp(3.861018d-1*(lnTgas(i)-1d0) &
            - 9.114733d-5*Tgas(i) &
            - 1.33545d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,314) = krate(i,70)*exp(2.039365d0*(lnTgas(i)-1d0) &
            - 8.55842d-3*Tgas(i) &
            + 5.821711d-6*Tgas2(i) &
            - 2.687074d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,314) = krate(i,70)*exp(-1.361725d0*(lnTgas(i)-1d0) &
            + 5.032744d-5*Tgas(i) &
            + 1.803258d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,315) = krate(i,71)*exp(4.468463d0*(lnTgas(i)-1d0) &
            - 8.475314d-3*Tgas(i) &
            + 4.624041d-6*Tgas2(i) &
            - 1.883545d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,315) = krate(i,71)*exp(6.310961d-1*(lnTgas(i)-1d0) &
            - 5.418875d-4*Tgas(i) &
            + 7.125405d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,315) = krate(i,315) / ntot(i)
    end do

    !HSO3 -> SO2 + OH
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,316) = krate(i,72)*exp(4.482077d0*(lnTgas(i)-1d0) &
            - 9.672905d-3*Tgas(i) &
            + 5.280526d-6*Tgas2(i) &
            - 2.124199d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,316) = krate(i,72)*exp(2.856084d-2*(lnTgas(i)-1d0) &
            - 4.957808d-4*Tgas(i) &
            + 7.049484d-8*Tgas2(i) &
            - 5.55515d-12*Tgas3(i) &
      ...
      !divided because pseudo-3body
      krate(i,316) = krate(i,316) / ntot(i)
    end do

    !SO2 -> CH3SCH3 + OH
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,317) = krate(i,73)*exp(5.597728d0*(lnTgas(i)-1d0) &
            - 1.118526d-3*Tgas(i) &
            + 6.816712d-6*Tgas2(i) &
            - 3.990816d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,317) = krate(i,73)*exp(3.920635d0*(lnTgas(i)-1d0) &
            + 7.508924d-3*Tgas(i) &
            - 8.588814d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,318) = krate(i,74)*exp(4.774011d0*(lnTgas(i)-1d0) &
            - 1.557652d-3*Tgas(i) &
            + 7.154449d-6*Tgas2(i) &
            - 4.178225d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,318) = krate(i,74)*exp(3.625742d0*(lnTgas(i)-1d0) &
            + 6.941559d-3*Tgas(i) &
            - 8.105797d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,319) = krate(i,75)*exp(3.171767d-1*(lnTgas(i)-1d0) &
            - 2.342044d-3*Tgas(i) &
            - 6.420484d-7*Tgas2(i) &
            ...
            - 8.072663d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,319) = krate(i,75)*exp(-2.545704d0*(lnTgas(i)-1d0) &
            - 2.859464d-4*Tgas(i) &
            + 5.634379d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,319) = krate(i,319) / ntot(i)
    end do

    !SO4 -> H2SO4
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,320) = krate(i,76)*exp(3.530814d0*(lnTgas(i)-1d0) &
            - 2.295174d-3*Tgas(i) &
            + 1.201235d-6*Tgas2(i) &
            ...
            - 1.51445d1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,320) = krate(i,76)*exp(1.251161d0*(lnTgas(i)-1d0) &
            + 1.315445d-3*Tgas(i) &
            - 1.302866d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,321) = krate(i,77)*exp(-9.6876d-4*(lnTgas(i)-1d0) &
            - 6.7128d-3*Tgas(i) &
            + 6.549928d-6*Tgas2(i) &
            - 3.2248d-9*Tgas3(i) &
            ...
            - 1.585919d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,321) = krate(i,77)*exp(-1.41118d0*(lnTgas(i)-1d0) &
            + 1.355588d-3*Tgas(i) &
            - 1.873897d-7*Tgas2(i) &
            + 1.60158d-11*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,322) = krate(i,78)*exp(1.43639d0*(lnTgas(i)-1d0) &
            - 5.447718d-3*Tgas(i) &
            + 1.95325d-6*Tgas2(i) &
            ...
            - 6.142107d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,322) = krate(i,78)*exp(-2.852322d0*(lnTgas(i)-1d0) &
            + 1.087508d-3*Tgas(i) &
            - 1.161445d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,323) = krate(i,79)*exp(5.101409d-1*(lnTgas(i)-1d0) &
            - 5.886128d-3*Tgas(i) &
            + 5.255125d-6*Tgas2(i) &
            - 2.618629d-9*Tgas3(i) &
            ...
            - 1.30219d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,323) = krate(i,79)*exp(-1.696922d0*(lnTgas(i)-1d0) &
            + 1.298314d-3*Tgas(i) &
            - 1.661587d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,324) = krate(i,80)*exp(-1.262676d0*(lnTgas(i)-1d0) &
            - 9.905654d-4*Tgas(i) &
            + 1.718222d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,324) = krate(i,80)*exp(-2.065936d0*(lnTgas(i)-1d0) &
            + 1.352754d-3*Tgas(i) &
            - 1.569633d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,325) = krate(i,81)*exp(-4.291299d0*(lnTgas(i)-1d0) &
            + 9.308139d-3*Tgas(i) &
            - 3.482714d-6*Tgas2(i) &
            + 6.69499d-10*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,325) = krate(i,81)*exp(7.528545d-1*(lnTgas(i)-1d0) &
            + 5.386365d-4*Tgas(i) &
            - 7.606508d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,326) = krate(i,82)*exp(4.390988d0*(lnTgas(i)-1d0) &
            - 6.436901d-3*Tgas(i) &
            + 2.463657d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,326) = krate(i,82)*exp(9.556118d-1*(lnTgas(i)-1d0) &
            - 7.085225d-4*Tgas(i) &
            + 8.431887d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,326) = krate(i,326) / ntot(i)
    end do

    !CHO -> H + CO
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,327) = krate(i,83)*exp(1.841987d0*(lnTgas(i)-1d0) &
            + 1.355199d-3*Tgas(i) &
            - 2.164369d-6*Tgas2(i) &
            + 1.19425d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,327) = krate(i,83)*exp(1.62847d0*(lnTgas(i)-1d0) &
            - 5.855326d-4*Tgas(i) &
            + 3.086835d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,327) = krate(i,327) / ntot(i)
    end do

    !H2 + CO -> H + CHO
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,328) = krate(i,84)*exp(8.136815d-1*(lnTgas(i)-1d0) &
            - 5.34546d-3*Tgas(i) &
            + 5.410727d-6*Tgas2(i) &
            - 2.874018d-9*Tgas3(i) &
            ...
            - 1.329754d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,328) = krate(i,84)*exp(4.386638d-1*(lnTgas(i)-1d0) &
            + 1.722286d-4*Tgas(i) &
            - 6.467958d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,329) = krate(i,85)*exp(1.018356d-1*(lnTgas(i)-1d0) &
            + 1.938591d-3*Tgas(i) &
            - 1.722127d-6*Tgas2(i) &
            ...
            + 2.50549d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,329) = krate(i,85)*exp(1.622018d0*(lnTgas(i)-1d0) &
            - 1.249674d-3*Tgas(i) &
            + 2.323916d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,330) = krate(i,86)*exp(4.513616d-1*(lnTgas(i)-1d0) &
            - 1.537532d-3*Tgas(i) &
            + 1.847085d-6*Tgas2(i) &
            - 1.060187d-9*Tgas3(i) &
            ...
            + 5.449499d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,330) = krate(i,86)*exp(1.033021d0*(lnTgas(i)-1d0) &
            - 3.473518d-4*Tgas(i) &
            + 4.909309d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,331) = krate(i,87)*exp(2.549d0*(lnTgas(i)-1d0) &
            - 7.792101d-3*Tgas(i) &
            + 4.628026d-6*Tgas2(i) &
            - 1.834114d-9*Tgas3(i) &
            ...
            - 4.093939d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,331) = krate(i,87)*exp(-6.728587d-1*(lnTgas(i)-1d0) &
            - 1.2299d-4*Tgas(i) &
            + 5.345052d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,332) = krate(i,88)*exp(-1.657045d-1*(lnTgas(i)-1d0) &
            - 1.794326d-3*Tgas(i) &
            + 2.502106d-6*Tgas2(i) &
            - 1.381659d-9*Tgas3(i) &
            ...
            + 1.955871d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,332) = krate(i,88)*exp(5.766362d-1*(lnTgas(i)-1d0) &
            + 1.8168d-5*Tgas(i) &
            + 1.74333d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,333) = krate(i,89)*exp(7.118459d-1*(lnTgas(i)-1d0) &
            - 7.284051d-3*Tgas(i) &
            + 7.132854d-6*Tgas2(i) &
            - 3.721811d-9*Tgas3(i) &
            + 8.08961d-13*Tgas4(i) &
            ...
            - 3.835244d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,333) = krate(i,89)*exp(-1.183355d0*(lnTgas(i)-1d0) &
            + 1.421902d-3*Tgas(i) &
            - 2.388595d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,334) = krate(i,90)*exp(-2.675401d-1*(lnTgas(i)-1d0) &
            - 3.732916d-3*Tgas(i) &
            + 4.224233d-6*Tgas2(i) &
            - 2.229452d-9*Tgas3(i) &
            ...
            - 5.496187d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,334) = krate(i,90)*exp(-1.045382d0*(lnTgas(i)-1d0) &
            + 1.267842d-3*Tgas(i) &
            - 2.149583d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,335) = krate(i,91)*exp(-1.647715d0*(lnTgas(i)-1d0) &
            + 5.19088d-3*Tgas(i) &
            - 4.015856d-6*Tgas2(i) &
            + 2.003062d-9*Tgas3(i) &
            ...
            + 5.850537d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,335) = krate(i,91)*exp(8.802017d-2*(lnTgas(i)-1d0) &
            - 1.335215d-4*Tgas(i) &
            + 2.292629d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,336) = krate(i,92)*exp(-3.623198d-1*(lnTgas(i)-1d0) &
            + 3.807928d-3*Tgas(i) &
            - 3.563642d-6*Tgas2(i) &
            + 1.813831d-9*Tgas3(i) &
            ...
            + 1.874704d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,336) = krate(i,92)*exp(5.943572d-1*(lnTgas(i)-1d0) &
            - 5.195803d-4*Tgas(i) &
            + 5.556105d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,337) = krate(i,93)*exp(2.536015d-1*(lnTgas(i)-1d0) &
            - 3.476407d-3*Tgas(i) &
            + 3.286498d-6*Tgas2(i) &
            - 1.745856d-9*Tgas3(i) &
            ...
            + 2.217038d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,337) = krate(i,93)*exp(-8.153549d-2*(lnTgas(i)-1d0) &
            - 2.641227d-4*Tgas(i) &
            + 9.790948d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,338) = krate(i,94)*exp(4.218492d0*(lnTgas(i)-1d0) &
            - 7.750528d-3*Tgas(i) &
            + 5.972407d-6*Tgas2(i) &
            - 2.916257d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,338) = krate(i,94)*exp(1.913866d0*(lnTgas(i)-1d0) &
            - 1.228811d-4*Tgas(i) &
            + 6.787752d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,338) = krate(i,338) / ntot(i)
    end do

    !SO2 + S2O -> SO + S2O2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,339) = krate(i,95)*exp(-5.621238d-2*(lnTgas(i)-1d0) &
            - 2.302379d-3*Tgas(i) &
            + 5.295561d-7*Tgas2(i) &
            ...
            - 1.603623d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,339) = krate(i,95)*exp(-1.415293d0*(lnTgas(i)-1d0) &
            - 6.510044d-4*Tgas(i) &
            + 1.066223d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,340) = krate(i,96)*exp(1.245127d0*(lnTgas(i)-1d0) &
            - 5.85334d-3*Tgas(i) &
            + 4.838645d-6*Tgas2(i) &
            - 2.534938d-9*Tgas3(i) &
            ...
            - 1.301006d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,340) = krate(i,96)*exp(-3.257153d-1*(lnTgas(i)-1d0) &
            - 2.068308d-4*Tgas(i) &
            + 6.559971d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,341) = krate(i,97)*exp(-1.356409d0*(lnTgas(i)-1d0) &
            + 4.533275d-3*Tgas(i) &
            - 2.987308d-6*Tgas2(i) &
            + 1.326786d-9*Tgas3(i) &
            ...
            + 3.532017d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,341) = krate(i,97)*exp(4.972483d-1*(lnTgas(i)-1d0) &
            - 1.22775d-4*Tgas(i) &
            + 3.466989d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,342) = krate(i,98)*exp(9.318368d-1*(lnTgas(i)-1d0) &
            + 1.795534d-3*Tgas(i) &
            - 3.288836d-6*Tgas2(i) &
            + 2.109145d-9*Tgas3(i) &
            ...
            - 3.558532d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,342) = krate(i,98)*exp(2.049013d-1*(lnTgas(i)-1d0) &
            - 2.852241d-4*Tgas(i) &
            + 2.719609d-8*Tgas2(i) &
            - 2.36317d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,343) = krate(i,99)*exp(1.523081d0*(lnTgas(i)-1d0) &
            - 4.757308d-3*Tgas(i) &
            + 3.470485d-6*Tgas2(i) &
            - 1.571912d-9*Tgas3(i) &
            ...
            - 5.174301d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,343) = krate(i,99)*exp(-2.807005d-1*(lnTgas(i)-1d0) &
            + 4.712474d-4*Tgas(i) &
            - 8.548808d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,344) = krate(i,100)*exp(1.206012d-1*(lnTgas(i)-1d0) &
            - 7.312091d-4*Tgas(i) &
            + 3.73533d-7*Tgas2(i) &
            ...
            - 2.219475d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,344) = krate(i,100)*exp(-6.977528d-1*(lnTgas(i)-1d0) &
            + 6.654306d-4*Tgas(i) &
            - 1.261754d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,345) = krate(i,101)*exp(1.757146d0*(lnTgas(i)-1d0) &
            + 2.278676d-3*Tgas(i) &
            - 3.728805d-6*Tgas2(i) &
            + 2.355543d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,345) = krate(i,101)*exp(1.926233d0*(lnTgas(i)-1d0) &
            - 9.555358d-4*Tgas(i) &
            + 1.277824d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,345) = krate(i,345) / ntot(i)
    end do

    !S3 -> S + S2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,346) = krate(i,102)*exp(2.520361d0*(lnTgas(i)-1d0) &
            - 4.394677d-3*Tgas(i) &
            + 2.278692d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,346) = krate(i,102)*exp(1.788388d-1*(lnTgas(i)-1d0) &
            - 5.55983d-5*Tgas(i) &
            + 3.147439d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,346) = krate(i,346) / ntot(i)
    end do

    !S4 -> S + S3
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,347) = krate(i,103)*exp(3.370273d0*(lnTgas(i)-1d0) &
            - 6.808341d-3*Tgas(i) &
            + 3.51533d-6*Tgas2(i) &
            - 1.309608d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,347) = krate(i,103)*exp(2.845701d-1*(lnTgas(i)-1d0) &
            - 4.678589d-4*Tgas(i) &
            + 7.040091d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,348) = krate(i,104)*exp(4.133488d0*(lnTgas(i)-1d0) &
            - 1.348169d-2*Tgas(i) &
            + 9.522827d-6*Tgas2(i) &
            - 4.519108d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,348) = krate(i,104)*exp(-1.462824d0*(lnTgas(i)-1d0) &
            + 4.320787d-4*Tgas(i) &
            - 2.590707d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,349) = krate(i,105)*exp(-8.890915d-1*(lnTgas(i)-1d0) &
            - 1.019551d-2*Tgas(i) &
            + 1.12212d-5*Tgas2(i) &
            - 7.091641d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,349) = krate(i,105)*exp(-2.175131d0*(lnTgas(i)-1d0) &
            - 1.67668d-3*Tgas(i) &
            + 3.655858d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,350) = krate(i,106)*exp(-1.757146d0*(lnTgas(i)-1d0) &
            - 2.278676d-3*Tgas(i) &
            + 3.728805d-6*Tgas2(i) &
            - 2.355543d-9*Tgas3(i) &
            + 5.772374d-13*Tgas4(i) &
            ...
            - 2.326109d0)*(1.3806488d-22*Tgas(i))**(1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,350) = krate(i,106)*exp(-1.926233d0*(lnTgas(i)-1d0) &
            + 9.555358d-4*Tgas(i) &
            - 1.277824d-7*Tgas2(i) &
            + 1.045632d-11*Tgas3(i) &
            - 3.530205d-16*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,351) = krate(i,107)*exp(1.097821d-1*(lnTgas(i)-1d0) &
            - 3.673751d-4*Tgas(i) &
            + 5.268929d-7*Tgas2(i) &
            - 3.77365d-10*Tgas3(i) &
            ...
            - 5.767928d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,351) = krate(i,107)*exp(-4.721737d-1*(lnTgas(i)-1d0) &
            + 4.977041d-4*Tgas(i) &
            - 8.745815d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,352) = krate(i,108)*exp(3.113642d0*(lnTgas(i)-1d0) &
            + 8.259561d-4*Tgas(i) &
            - 4.258941d-6*Tgas2(i) &
            + 2.880087d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,352) = krate(i,108)*exp(7.639652d-1*(lnTgas(i)-1d0) &
            - 8.354445d-4*Tgas(i) &
            + 1.195469d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,353) = krate(i,109)*exp(-4.682763d-1*(lnTgas(i)-1d0) &
            + 4.377806d-3*Tgas(i) &
            - 4.203424d-6*Tgas2(i) &
            + 2.09853d-9*Tgas3(i) &
            ...
            + 3.569354d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,353) = krate(i,109)*exp(-1.477691d-1*(lnTgas(i)-1d0) &
            - 2.113349d-4*Tgas(i) &
            + 4.513223d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,354) = krate(i,110)*exp(1.008922d0*(lnTgas(i)-1d0) &
            + 7.913419d-3*Tgas(i) &
            - 7.319426d-6*Tgas2(i) &
            + 3.548094d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,354) = krate(i,110)*exp(3.566335d0*(lnTgas(i)-1d0) &
            - 1.902414d-3*Tgas(i) &
            + 2.347164d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,354) = krate(i,354) / ntot(i)
    end do

    !CH3O + O2 -> O3 + CH3
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,355) = krate(i,111)*exp(-4.296995d-1*(lnTgas(i)-1d0) &
            + 4.990878d-3*Tgas(i) &
            - 4.699234d-6*Tgas2(i) &
            + 2.336604d-9*Tgas3(i) &
            ...
            - 2.740732d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,355) = krate(i,111)*exp(6.889659d0*(lnTgas(i)-1d0) &
            - 7.116208d-3*Tgas(i) &
            + 1.475006d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,356) = krate(i,112)*exp(-1.477724d0*(lnTgas(i)-1d0) &
            + 9.864285d-3*Tgas(i) &
            - 7.905735d-6*Tgas2(i) &
            + 3.681436d-9*Tgas3(i) &
            ...
            + 5.863834d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,356) = krate(i,112)*exp(1.47382d0*(lnTgas(i)-1d0) &
            - 8.163719d-4*Tgas(i) &
            + 7.60214d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,357) = krate(i,113)*exp(1.437359d0*(lnTgas(i)-1d0) &
            + 1.265082d-3*Tgas(i) &
            - 4.596678d-6*Tgas2(i) &
            + 3.067495d-9*Tgas3(i) &
            - 7.41497d-13*Tgas4(i) &
            ...
            - 4.556189d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,357) = krate(i,113)*exp(-1.441141d0*(lnTgas(i)-1d0) &
            - 2.680799d-4*Tgas(i) &
            + 7.124526d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,358) = krate(i,114)*exp(-6.673605d-1*(lnTgas(i)-1d0) &
            + 8.352546d-3*Tgas(i) &
            - 7.657163d-6*Tgas2(i) &
            + 3.735503d-9*Tgas3(i) &
            ...
            + 4.150831d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,358) = krate(i,114)*exp(1.361228d0*(lnTgas(i)-1d0) &
            - 1.335049d-3*Tgas(i) &
            + 1.864147d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,359) = krate(i,115)*exp(1.990653d0*(lnTgas(i)-1d0) &
            + 8.011937d-3*Tgas(i) &
            - 9.853131d-6*Tgas2(i) &
            + 5.445002d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,359) = krate(i,115)*exp(2.289383d0*(lnTgas(i)-1d0) &
            - 1.706307d-3*Tgas(i) &
            + 2.265582d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,360) = krate(i,116)*exp(2.551885d-1*(lnTgas(i)-1d0) &
            + 1.291588d-3*Tgas(i) &
            - 2.609176d-6*Tgas2(i) &
            + 1.69099d-9*Tgas3(i) &
            ...
            - 1.078213d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,360) = krate(i,116)*exp(-4.459147d-1*(lnTgas(i)-1d0) &
            - 4.349047d-4*Tgas(i) &
            + 1.115324d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,361) = krate(i,117)*exp(-9.717359d-1*(lnTgas(i)-1d0) &
            + 7.037226d-3*Tgas(i) &
            - 5.434261d-6*Tgas2(i) &
            + 2.331836d-9*Tgas3(i) &
            ...
            + 6.365749d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,361) = krate(i,117)*exp(1.577661d0*(lnTgas(i)-1d0) &
            - 1.290009d-3*Tgas(i) &
            + 2.005285d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,362) = krate(i,118)*exp(-8.33065d-1*(lnTgas(i)-1d0) &
            + 6.55822d-3*Tgas(i) &
            - 5.155057d-6*Tgas2(i) &
            + 2.353844d-9*Tgas3(i) &
            ...
            + 6.106702d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,362) = krate(i,118)*exp(1.937864d0*(lnTgas(i)-1d0) &
            - 1.316881d-3*Tgas(i) &
            + 2.03848d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,363) = krate(i,119)*exp(-2.027211d0*(lnTgas(i)-1d0) &
            + 1.014224d-2*Tgas(i) &
            - 7.769155d-6*Tgas2(i) &
            + 3.549074d-9*Tgas3(i) &
            ...
            + 8.727032d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,363) = krate(i,119)*exp(9.094383d-1*(lnTgas(i)-1d0) &
            - 4.514574d-4*Tgas(i) &
            + 4.156442d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,364) = krate(i,120)*exp(-3.036134d0*(lnTgas(i)-1d0) &
            + 2.228825d-3*Tgas(i) &
            - 4.497294d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,364) = krate(i,120)*exp(-2.656896d0*(lnTgas(i)-1d0) &
            + 1.450956d-3*Tgas(i) &
            - 1.93152d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,365) = krate(i,121)*exp(-2.17691d0*(lnTgas(i)-1d0) &
            - 3.089122d-3*Tgas(i) &
            + 4.437752d-6*Tgas2(i) &
            - 2.494846d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,365) = krate(i,121)*exp(-2.475682d0*(lnTgas(i)-1d0) &
            + 1.60294d-3*Tgas(i) &
            - 2.279502d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,366) = krate(i,122)*exp(-2.572996d0*(lnTgas(i)-1d0) &
            + 1.146527d-2*Tgas(i) &
            - 7.263909d-6*Tgas2(i) &
            + 2.766537d-9*Tgas3(i) &
            ...
            + 1.227637d1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,366) = krate(i,122)*exp(2.6546d0*(lnTgas(i)-1d0) &
            - 1.278304d-3*Tgas(i) &
            + 1.603017d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,367) = krate(i,123)*exp(-1.806478d0*(lnTgas(i)-1d0) &
            + 1.219224d-2*Tgas(i) &
            - 8.898364d-6*Tgas2(i) &
            + 3.668243d-9*Tgas3(i) &
            ...
            + 9.013084d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,367) = krate(i,123)*exp(2.989928d0*(lnTgas(i)-1d0) &
            - 2.025224d-3*Tgas(i) &
            + 2.656495d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,368) = krate(i,124)*exp(1.205265d0*(lnTgas(i)-1d0) &
            + 1.221149d-3*Tgas(i) &
            - 3.686399d-6*Tgas2(i) &
            + 2.524146d-9*Tgas3(i) &
            - 6.31499d-13*Tgas4(i) &
            ...
            - 8.65627d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,368) = krate(i,124)*exp(-9.821593d-1*(lnTgas(i)-1d0) &
            + 1.868195d-5*Tgas(i) &
            + 3.000115d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,369) = krate(i,125)*exp(-1.646746d0*(lnTgas(i)-1d0) &
            + 1.190368d-2*Tgas(i) &
            - 1.056578d-5*Tgas2(i) &
            + 5.227862d-9*Tgas3(i) &
            ...
            + 7.436456d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,369) = krate(i,125)*exp(1.4992d0*(lnTgas(i)-1d0) &
            - 1.48911d-3*Tgas(i) &
            + 2.10316d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,370) = krate(i,126)*exp(6.240342d-1*(lnTgas(i)-1d0) &
            - 1.144809d-3*Tgas(i) &
            + 1.328003d-7*Tgas2(i) &
            ...
            - 1.556467d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,370) = krate(i,126)*exp(-7.413616d-1*(lnTgas(i)-1d0) &
            + 1.729149d-4*Tgas(i) &
            - 2.49757d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,371) = krate(i,127)*exp(-1.217953d0*(lnTgas(i)-1d0) &
            - 2.500008d-3*Tgas(i) &
            + 2.297169d-6*Tgas2(i) &
            - 1.138744d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,371) = krate(i,127)*exp(-2.369832d0*(lnTgas(i)-1d0) &
            + 7.584475d-4*Tgas(i) &
            - 5.584406d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,372) = krate(i,128)*exp(1.437716d0*(lnTgas(i)-1d0) &
            - 6.490269d-3*Tgas(i) &
            + 5.543528d-6*Tgas2(i) &
            - 2.818512d-9*Tgas3(i) &
            ...
            - 2.88622d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,372) = krate(i,128)*exp(-3.026978d-1*(lnTgas(i)-1d0) &
            + 3.451434d-4*Tgas(i) &
            - 3.144366d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,373) = krate(i,129)*exp(8.592238d-1*(lnTgas(i)-1d0) &
            - 5.317947d-3*Tgas(i) &
            + 4.887482d-6*Tgas2(i) &
            - 2.495826d-9*Tgas3(i) &
            ...
            - 3.960711d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,373) = krate(i,129)*exp(1.812142d-1*(lnTgas(i)-1d0) &
            + 1.519837d-4*Tgas(i) &
            - 3.479819d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,374) = krate(i,130)*exp(6.189566d-1*(lnTgas(i)-1d0) &
            - 7.155958d-3*Tgas(i) &
            + 4.187688d-6*Tgas2(i) &
            - 1.564038d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,374) = krate(i,130)*exp(-2.840534d0*(lnTgas(i)-1d0) &
            + 4.054241d-4*Tgas(i) &
            + 6.346646d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,375) = krate(i,131)*exp(3.274625d0*(lnTgas(i)-1d0) &
            - 1.114622d-2*Tgas(i) &
            + 7.434047d-6*Tgas2(i) &
            - 3.243805d-9*Tgas3(i) &
            ...
            - 7.672972d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,375) = krate(i,131)*exp(-7.733993d-1*(lnTgas(i)-1d0) &
            - 7.879927d-6*Tgas(i) &
            + 3.074704d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,376) = krate(i,132)*exp(1.976009d-1*(lnTgas(i)-1d0) &
            - 1.340515d-3*Tgas(i) &
            + 1.744485d-6*Tgas2(i) &
            ...
            + 2.515411d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,376) = krate(i,132)*exp(1.070453d0*(lnTgas(i)-1d0) &
            - 3.863023d-4*Tgas(i) &
            + 5.029087d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,377) = krate(i,133)*exp(1.377939d-2*(lnTgas(i)-1d0) &
            + 3.929933d-3*Tgas(i) &
            - 4.326833d-6*Tgas2(i) &
            + 2.31212d-9*Tgas3(i) &
            ...
            + 2.562099d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,377) = krate(i,133)*exp(1.082814d0*(lnTgas(i)-1d0) &
            - 1.306792d-3*Tgas(i) &
            + 2.16156d-7*Tgas2(i) &
            - 1.97315d-11*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,378) = krate(i,134)*exp(8.915744d-1*(lnTgas(i)-1d0) &
            + 2.588107d-3*Tgas(i) &
            - 4.091432d-6*Tgas2(i) &
            + 2.284958d-9*Tgas3(i) &
            ...
            - 1.006848d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,378) = krate(i,134)*exp(3.040205d-1*(lnTgas(i)-1d0) &
            - 1.094927d-3*Tgas(i) &
            + 1.899826d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,379) = krate(i,135)*exp(1.194146d0*(lnTgas(i)-1d0) &
            - 3.584024d-3*Tgas(i) &
            + 2.614098d-6*Tgas2(i) &
            - 1.19523d-9*Tgas3(i) &
            ...
            - 2.62033d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,379) = krate(i,135)*exp(1.028426d0*(lnTgas(i)-1d0) &
            - 8.654238d-4*Tgas(i) &
            + 1.622836d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,380) = krate(i,136)*exp(6.594806d-1*(lnTgas(i)-1d0) &
            + 2.544174d-3*Tgas(i) &
            - 3.181153d-6*Tgas2(i) &
            + 1.741609d-9*Tgas3(i) &
            ...
            - 5.106929d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,380) = krate(i,136)*exp(7.630027d-1*(lnTgas(i)-1d0) &
            - 8.081649d-4*Tgas(i) &
            + 1.487385d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,381) = krate(i,137)*exp(-1.82313d0*(lnTgas(i)-1d0) &
            + 8.585882d-3*Tgas(i) &
            - 6.217352d-6*Tgas2(i) &
            + 2.737413d-9*Tgas3(i) &
            ...
            + 5.042962d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,381) = krate(i,137)*exp(1.553515d0*(lnTgas(i)-1d0) &
            - 9.537688d-4*Tgas(i) &
            + 1.539653d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,382) = krate(i,138)*exp(5.784919d-1*(lnTgas(i)-1d0) &
            - 1.172322d-3*Tgas(i) &
            + 6.560458d-7*Tgas2(i) &
            ...
            + 1.074491d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,382) = krate(i,138)*exp(-4.83912d-1*(lnTgas(i)-1d0) &
            + 1.931598d-4*Tgas(i) &
            + 3.354526d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,383) = krate(i,139)*exp(-1.022356d0*(lnTgas(i)-1d0) &
            + 3.349763d-3*Tgas(i) &
            - 1.679916d-6*Tgas2(i) &
            ...
            + 2.807317d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,383) = krate(i,139)*exp(2.249631d-1*(lnTgas(i)-1d0) &
            + 1.119774d-4*Tgas(i) &
            - 3.156981d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,384) = krate(i,140)*exp(-1.335985d-1*(lnTgas(i)-1d0) &
            + 1.963829d-3*Tgas(i) &
            - 2.081461d-6*Tgas2(i) &
            + 1.086134d-9*Tgas3(i) &
            ...
            + 3.816777d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,384) = krate(i,140)*exp(-2.817548d-1*(lnTgas(i)-1d0) &
            - 3.687364d-5*Tgas(i) &
            + 1.209471d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,385) = krate(i,141)*exp(-2.993031d-1*(lnTgas(i)-1d0) &
            + 1.695038d-4*Tgas(i) &
            + 4.206454d-7*Tgas2(i) &
            ...
            + 2.337549d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,385) = krate(i,141)*exp(2.948813d-1*(lnTgas(i)-1d0) &
            - 1.870564d-5*Tgas(i) &
            + 2.952801d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,386) = krate(i,142)*exp(3.946704d-1*(lnTgas(i)-1d0) &
            + 4.098127d-3*Tgas(i) &
            - 5.415272d-6*Tgas2(i) &
            + 2.966953d-9*Tgas3(i) &
            ...
            + 1.07916d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,386) = krate(i,142)*exp(-4.715508d-1*(lnTgas(i)-1d0) &
            - 7.2733d-4*Tgas(i) &
            + 1.692197d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,387) = krate(i,143)*exp(-8.592238d-1*(lnTgas(i)-1d0) &
            + 5.317947d-3*Tgas(i) &
            - 4.887482d-6*Tgas2(i) &
            + 2.495826d-9*Tgas3(i) &
            - 5.357315d-13*Tgas4(i) &
            ...
            + 3.960711d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,387) = krate(i,143)*exp(-1.812142d-1*(lnTgas(i)-1d0) &
            - 1.519837d-4*Tgas(i) &
            + 3.479819d-8*Tgas2(i) &
            - 3.239415d-12*Tgas3(i) &
            + 1.163187d-16*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,388) = krate(i,144)*exp(2.17691d0*(lnTgas(i)-1d0) &
            + 3.089122d-3*Tgas(i) &
            - 4.437752d-6*Tgas2(i) &
            + 2.494846d-9*Tgas3(i) &
            - 5.624003d-13*Tgas4(i) &
            ...
            + 1.093759d0)*(1.3806488d-22*Tgas(i))**(-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,388) = krate(i,144)*exp(2.475682d0*(lnTgas(i)-1d0) &
            - 1.60294d-3*Tgas(i) &
            + 2.279502d-7*Tgas2(i) &
            - 1.938318d-11*Tgas3(i) &
            + 6.940581d-16*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,389) = krate(i,145)*exp(2.482839d0*(lnTgas(i)-1d0) &
            - 8.975679d-3*Tgas(i) &
            + 5.706182d-6*Tgas2(i) &
            - 2.378487d-9*Tgas3(i) &
            ...
            - 9.890009d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,389) = krate(i,145)*exp(-1.073628d0*(lnTgas(i)-1d0) &
            - 1.272959d-5*Tgas(i) &
            + 3.783904d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,390) = krate(i,146)*exp(1.716321d0*(lnTgas(i)-1d0) &
            - 9.702647d-3*Tgas(i) &
            + 7.340637d-6*Tgas2(i) &
            - 3.280193d-9*Tgas3(i) &
            ...
            - 6.62672d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,390) = krate(i,146)*exp(-1.408956d0*(lnTgas(i)-1d0) &
            + 7.3419d-4*Tgas(i) &
            - 6.750871d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,391) = krate(i,147)*exp(1.122988d0*(lnTgas(i)-1d0) &
            - 7.185981d-3*Tgas(i) &
            + 5.59419d-6*Tgas2(i) &
            - 2.564916d-9*Tgas3(i) &
            ...
            - 5.313807d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,391) = krate(i,147)*exp(-1.525418d0*(lnTgas(i)-1d0) &
            + 8.708622d-4*Tgas(i) &
            - 1.070113d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,392) = krate(i,148)*exp(3.564702d-1*(lnTgas(i)-1d0) &
            - 7.912949d-3*Tgas(i) &
            + 7.228645d-6*Tgas2(i) &
            - 3.466621d-9*Tgas3(i) &
            ...
            - 2.050518d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,392) = krate(i,148)*exp(-1.860746d0*(lnTgas(i)-1d0) &
            + 1.617782d-3*Tgas(i) &
            - 2.12359d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,393) = krate(i,149)*exp(3.026956d-1*(lnTgas(i)-1d0) &
            - 8.194269d-3*Tgas(i) &
            + 9.535848d-6*Tgas2(i) &
            - 5.310939d-9*Tgas3(i) &
            ...
            - 2.16854d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,393) = krate(i,149)*exp(3.721085d-1*(lnTgas(i)-1d0) &
            + 7.734223d-4*Tgas(i) &
            - 1.465968d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,394) = krate(i,150)*exp(2.102374d0*(lnTgas(i)-1d0) &
            - 1.073711d-2*Tgas(i) &
            + 8.502812d-6*Tgas2(i) &
            - 4.057274d-9*Tgas3(i) &
            ...
            - 8.599432d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,394) = krate(i,150)*exp(-1.66339d0*(lnTgas(i)-1d0) &
            + 1.024923d-3*Tgas(i) &
            - 1.309126d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,395) = krate(i,151)*exp(1.335856d0*(lnTgas(i)-1d0) &
            - 1.146408d-2*Tgas(i) &
            + 1.013727d-5*Tgas2(i) &
            - 4.95898d-9*Tgas3(i) &
            + 1.03141d-12*Tgas4(i) &
            ...
            - 5.336143d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,395) = krate(i,151)*exp(-1.998718d0*(lnTgas(i)-1d0) &
            + 1.771842d-3*Tgas(i) &
            - 2.362603d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,396) = krate(i,152)*exp(1.740055d0*(lnTgas(i)-1d0) &
            - 6.929187d-3*Tgas(i) &
            + 4.93917d-6*Tgas2(i) &
            - 2.243443d-9*Tgas3(i) &
            + 4.48757d-13*Tgas4(i) &
            ...
            - 6.724729d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,396) = krate(i,152)*exp(-1.069033d0*(lnTgas(i)-1d0) &
            + 5.053424d-4*Tgas(i) &
            - 7.53515d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,397) = krate(i,153)*exp(9.735364d-1*(lnTgas(i)-1d0) &
            - 7.656155d-3*Tgas(i) &
            + 6.573624d-6*Tgas2(i) &
            - 3.145149d-9*Tgas3(i) &
            ...
            - 3.46144d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,397) = krate(i,153)*exp(-1.404361d0*(lnTgas(i)-1d0) &
            + 1.252262d-3*Tgas(i) &
            - 1.806993d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,398) = krate(i,154)*exp(-1.841864d0*(lnTgas(i)-1d0) &
            - 3.377337d-3*Tgas(i) &
            + 4.994686d-6*Tgas2(i) &
            - 3.025d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,398) = krate(i,154)*exp(-1.980767d0*(lnTgas(i)-1d0) &
            + 1.129452d-3*Tgas(i) &
            - 1.497662d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,399) = krate(i,155)*exp(4.556279d-1*(lnTgas(i)-1d0) &
            + 1.166565d-3*Tgas(i) &
            - 2.062972d-6*Tgas2(i) &
            + 1.170587d-9*Tgas3(i) &
            ...
            - 1.162976d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,399) = krate(i,155)*exp(-1.641898d-1*(lnTgas(i)-1d0) &
            - 4.64187d-4*Tgas(i) &
            + 7.940346d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,400) = krate(i,156)*exp(-3.108903d-1*(lnTgas(i)-1d0) &
            + 4.395969d-4*Tgas(i) &
            - 4.28518d-7*Tgas2(i) &
            ...
            + 2.100312d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,400) = krate(i,156)*exp(-4.995178d-1*(lnTgas(i)-1d0) &
            + 2.827326d-4*Tgas(i) &
            - 2.59443d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,401) = krate(i,157)*exp(2.207336d-1*(lnTgas(i)-1d0) &
            + 2.049993d-3*Tgas(i) &
            - 1.129209d-6*Tgas2(i) &
            ...
            + 2.860521d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,401) = krate(i,157)*exp(2.08049d0*(lnTgas(i)-1d0) &
            - 1.573766d-3*Tgas(i) &
            + 2.240851d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,402) = krate(i,158)*exp(-1.139117d0*(lnTgas(i)-1d0) &
            + 3.839692d-3*Tgas(i) &
            - 1.241201d-6*Tgas2(i) &
            ...
            + 4.862254d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,402) = krate(i,158)*exp(1.6287d0*(lnTgas(i)-1d0) &
            - 6.901746d-4*Tgas(i) &
            + 7.923472d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,403) = krate(i,159)*exp(-6.708408d-1*(lnTgas(i)-1d0) &
            - 5.381141d-4*Tgas(i) &
            + 2.962224d-6*Tgas2(i) &
            - 2.16579d-9*Tgas3(i) &
            ...
            + 1.2929d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,403) = krate(i,159)*exp(1.776469d0*(lnTgas(i)-1d0) &
            - 4.788397d-4*Tgas(i) &
            + 3.410249d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,404) = krate(i,160)*exp(1.319813d0*(lnTgas(i)-1d0) &
            + 7.473823d-3*Tgas(i) &
            - 6.890907d-6*Tgas2(i) &
            + 3.279213d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,404) = krate(i,160)*exp(4.065852d0*(lnTgas(i)-1d0) &
            - 2.185146d-3*Tgas(i) &
            + 2.606607d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,405) = krate(i,161)*exp(-1.597311d-1*(lnTgas(i)-1d0) &
            + 2.885578d-4*Tgas(i) &
            + 1.66742d-6*Tgas2(i) &
            - 1.559619d-9*Tgas3(i) &
            ...
            + 1.576629d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,405) = krate(i,161)*exp(1.490728d0*(lnTgas(i)-1d0) &
            - 5.361141d-4*Tgas(i) &
            + 5.533346d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,406) = krate(i,162)*exp(-1.166834d0*(lnTgas(i)-1d0) &
            + 9.424688d-3*Tgas(i) &
            - 7.477217d-6*Tgas2(i) &
            + 3.412554d-9*Tgas3(i) &
            ...
            + 3.763521d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,406) = krate(i,162)*exp(1.973338d0*(lnTgas(i)-1d0) &
            - 1.099105d-3*Tgas(i) &
            + 1.019657d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,407) = krate(i,163)*exp(-5.220509d-1*(lnTgas(i)-1d0) &
            + 4.096486d-3*Tgas(i) &
            - 1.896222d-6*Tgas2(i) &
            ...
            + 3.451332d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,407) = krate(i,163)*exp(2.085085d0*(lnTgas(i)-1d0) &
            - 1.055694d-3*Tgas(i) &
            + 1.108945d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,408) = krate(i,164)*exp(-3.287534d-1*(lnTgas(i)-1d0) &
            + 2.327953d-3*Tgas(i) &
            - 9.926283d-7*Tgas2(i) &
            ...
            + 3.149251d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,408) = krate(i,164)*exp(1.516108d0*(lnTgas(i)-1d0) &
            - 1.208852d-3*Tgas(i) &
            + 1.896281d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,409) = krate(i,165)*exp(-5.221747d-1*(lnTgas(i)-1d0) &
            + 6.118623d-3*Tgas(i) &
            - 4.726539d-6*Tgas2(i) &
            + 2.084962d-9*Tgas3(i) &
            ...
            + 4.00639d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,409) = krate(i,165)*exp(2.437382d0*(lnTgas(i)-1d0) &
            - 1.599614d-3*Tgas(i) &
            + 2.297923d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,410) = krate(i,166)*exp(-8.71577d-1*(lnTgas(i)-1d0) &
            + 7.572608d-3*Tgas(i) &
            - 5.465433d-6*Tgas2(i) &
            + 2.162192d-9*Tgas3(i) &
            ...
            + 5.411872d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,410) = krate(i,166)*exp(2.674082d0*(lnTgas(i)-1d0) &
            - 1.958016d-3*Tgas(i) &
            + 2.94193d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,411) = krate(i,167)*exp(-1.495587d0*(lnTgas(i)-1d0) &
            + 1.175264d-2*Tgas(i) &
            - 8.469846d-6*Tgas2(i) &
            + 3.399361d-9*Tgas3(i) &
            ...
            + 6.912772d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,411) = krate(i,167)*exp(3.489446d0*(lnTgas(i)-1d0) &
            - 2.307956d-3*Tgas(i) &
            + 2.915938d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,412) = krate(i,168)*exp(-1.10441d0*(lnTgas(i)-1d0) &
            + 2.461233d-3*Tgas(i) &
            - 1.306678d-6*Tgas2(i) &
            ...
            + 3.519041d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,412) = krate(i,168)*exp(2.725542d-1*(lnTgas(i)-1d0) &
            - 1.662193d-4*Tgas(i) &
            + 2.88566d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,413) = krate(i,169)*exp(1.932658d-2*(lnTgas(i)-1d0) &
            - 6.184507d-4*Tgas(i) &
            + 8.173734d-7*Tgas2(i) &
            ...
            + 1.455115d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,413) = krate(i,169)*exp(1.804419d-1*(lnTgas(i)-1d0) &
            - 1.841076d-6*Tgas(i) &
            - 8.554073d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,414) = krate(i,170)*exp(-1.766552d0*(lnTgas(i)-1d0) &
            + 2.727759d-3*Tgas(i) &
            + 1.661445d-7*Tgas2(i) &
            ...
            + 3.688698d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,414) = krate(i,170)*exp(1.285511d0*(lnTgas(i)-1d0) &
            - 6.301437d-5*Tgas(i) &
            - 1.749104d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,415) = krate(i,171)*exp(-2.384627d0*(lnTgas(i)-1d0) &
            + 5.896556d-3*Tgas(i) &
            - 1.469131d-6*Tgas2(i) &
            - 3.43961d-10*Tgas3(i) &
            ...
            + 6.684475d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,415) = krate(i,171)*exp(1.481399d0*(lnTgas(i)-1d0) &
            - 1.391785d-4*Tgas(i) &
            - 7.404981d-9*Tgas2(i) &
            - 6.5501d-14*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,416) = krate(i,172)*exp(4.549239d0*(lnTgas(i)-1d0) &
            - 1.721463d-3*Tgas(i) &
            - 4.054954d-6*Tgas2(i) &
            + 3.297731d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,416) = krate(i,172)*exp(2.456874d-1*(lnTgas(i)-1d0) &
            - 8.9825d-4*Tgas(i) &
            + 1.38093d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,416) = krate(i,416) / ntot(i)
    end do

    !N2H3 + H2 -> N2H4 + H
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,417) = krate(i,173)*exp(5.691353d-1*(lnTgas(i)-1d0) &
            - 4.989333d-3*Tgas(i) &
            + 5.802848d-6*Tgas2(i) &
            - 3.354613d-9*Tgas3(i) &
            ...
            - 3.208736d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,417) = krate(i,173)*exp(4.618722d-1*(lnTgas(i)-1d0) &
            + 3.06131d-4*Tgas(i) &
            - 6.188837d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,418) = krate(i,174)*exp(-2.462705d0*(lnTgas(i)-1d0) &
            + 2.720536d-3*Tgas(i) &
            + 1.498464d-6*Tgas2(i) &
            - 1.622886d-9*Tgas3(i) &
            ...
            + 7.566037d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,418) = krate(i,174)*exp(1.359575d0*(lnTgas(i)-1d0) &
            + 1.78815d-4*Tgas(i) &
            - 5.180425d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,419) = krate(i,175)*exp(1.885598d-1*(lnTgas(i)-1d0) &
            - 9.01679d-4*Tgas(i) &
            + 9.06933d-7*Tgas2(i) &
            - 4.51252d-10*Tgas3(i) &
            ...
            + 1.265488d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,419) = krate(i,175)*exp(2.533321d-1*(lnTgas(i)-1d0) &
            + 8.27847d-6*Tgas(i) &
            - 1.121273d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,420) = krate(i,176)*exp(1.692332d-1*(lnTgas(i)-1d0) &
            - 2.832283d-4*Tgas(i) &
            + 8.955956d-8*Tgas2(i) &
            ...
            - 1.896271d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,420) = krate(i,176)*exp(7.289018d-2*(lnTgas(i)-1d0) &
            + 1.011955d-5*Tgas(i) &
            - 2.658662d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,421) = krate(i,177)*exp(6.809386d-1*(lnTgas(i)-1d0) &
            - 2.262923d-3*Tgas(i) &
            + 1.950754d-6*Tgas2(i) &
            ...
            + 7.167012d-2)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,421) = krate(i,177)*exp(2.237276d-1*(lnTgas(i)-1d0) &
            + 1.488827d-4*Tgas(i) &
            - 4.09064d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,422) = krate(i,178)*exp(-1.246873d-1*(lnTgas(i)-1d0) &
            - 1.618038d-3*Tgas(i) &
            + 1.698842d-6*Tgas2(i) &
            ...
            + 2.171037d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,422) = krate(i,178)*exp(-4.859893d-1*(lnTgas(i)-1d0) &
            + 5.06124d-4*Tgas(i) &
            - 6.135346d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,423) = krate(i,179)*exp(-1.223275d0*(lnTgas(i)-1d0) &
            - 6.202754d-4*Tgas(i) &
            + 1.6411d-6*Tgas2(i) &
            ...
            + 3.466815d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,423) = krate(i,179)*exp(-8.418093d-1*(lnTgas(i)-1d0) &
            + 7.885067d-4*Tgas(i) &
            - 1.061022d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,424) = krate(i,180)*exp(6.212039d-2*(lnTgas(i)-1d0) &
            - 2.003227d-3*Tgas(i) &
            + 2.093314d-6*Tgas2(i) &
            - 1.11893d-9*Tgas3(i) &
            ...
            - 5.090189d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,424) = krate(i,180)*exp(-3.354723d-1*(lnTgas(i)-1d0) &
            + 4.024479d-4*Tgas(i) &
            - 7.346739d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,425) = krate(i,181)*exp(2.231229d0*(lnTgas(i)-1d0) &
            + 1.820895d-3*Tgas(i) &
            - 2.410598d-6*Tgas2(i) &
            + 1.252994d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,425) = krate(i,181)*exp(2.996964d0*(lnTgas(i)-1d0) &
            - 1.335332d-3*Tgas(i) &
            + 1.534288d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,425) = krate(i,425) / ntot(i)
    end do

    !N2O + H -> NH + NO
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,426) = krate(i,182)*exp(2.954399d0*(lnTgas(i)-1d0) &
            - 7.816407d-3*Tgas(i) &
            + 3.871093d-6*Tgas2(i) &
            - 1.378405d-9*Tgas3(i) &
            ...
            - 6.182349d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,426) = krate(i,182)*exp(-1.278634d0*(lnTgas(i)-1d0) &
            - 5.307744d-5*Tgas(i) &
            + 1.743342d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,427) = krate(i,183)*exp(-5.738149d-2*(lnTgas(i)-1d0) &
            + 8.361791d-4*Tgas(i) &
            - 9.817179d-7*Tgas2(i) &
            ...
            + 2.066356d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,427) = krate(i,183)*exp(-4.333489d-1*(lnTgas(i)-1d0) &
            + 5.576564d-5*Tgas(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,428) = krate(i,184)*exp(-1.055502d0*(lnTgas(i)-1d0) &
            + 5.350838d-3*Tgas(i) &
            - 3.806463d-6*Tgas2(i) &
            + 1.546805d-9*Tgas3(i) &
            - 2.66286d-13*Tgas4(i) &
            ...
            + 5.820687d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,428) = krate(i,184)*exp(1.013599d0*(lnTgas(i)-1d0) &
            - 7.326382d-4*Tgas(i) &
            + 9.763184d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,429) = krate(i,185)*exp(-2.992212d0*(lnTgas(i)-1d0) &
            + 7.256481d-3*Tgas(i) &
            - 2.57692d-6*Tgas2(i) &
            ...
            + 7.708101d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,429) = krate(i,185)*exp(1.794545d0*(lnTgas(i)-1d0) &
            - 2.528341d-4*Tgas(i) &
            + 1.915011d-8*Tgas2(i) &
            - 9.22769d-13*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,430) = krate(i,186)*exp(-2.367654d0*(lnTgas(i)-1d0) &
            + 8.76811d-3*Tgas(i) &
            - 6.081598d-6*Tgas2(i) &
            + 2.854825d-9*Tgas3(i) &
            ...
            + 6.436286d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,430) = krate(i,186)*exp(1.372943d0*(lnTgas(i)-1d0) &
            - 3.238185d-4*Tgas(i) &
            + 3.704401d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,431) = krate(i,187)*exp(1.68469d0*(lnTgas(i)-1d0) &
            - 8.59614d-3*Tgas(i) &
            + 7.567425d-6*Tgas2(i) &
            - 3.987796d-9*Tgas3(i) &
            ...
            - 5.101077d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,431) = krate(i,187)*exp(1.90774d-2*(lnTgas(i)-1d0) &
            - 1.958738d-4*Tgas(i) &
            + 2.242506d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,432) = krate(i,188)*exp(2.992212d0*(lnTgas(i)-1d0) &
            - 7.256481d-3*Tgas(i) &
            + 2.57692d-6*Tgas2(i) &
            - 3.914262d-10*Tgas3(i) &
            - 3.183218d-14*Tgas4(i) &
            ...
            - 7.708101d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,432) = krate(i,188)*exp(-1.794545d0*(lnTgas(i)-1d0) &
            + 2.528341d-4*Tgas(i) &
            - 1.915011d-8*Tgas2(i) &
            + 9.22769d-13*Tgas3(i) &
            - 1.413092d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,433) = krate(i,189)*exp(-1.116324d0*(lnTgas(i)-1d0) &
            + 5.227182d-3*Tgas(i) &
            - 3.189675d-6*Tgas2(i) &
            + 1.369383d-9*Tgas3(i) &
            ...
            + 7.274798d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,433) = krate(i,189)*exp(1.611705d0*(lnTgas(i)-1d0) &
            - 2.875669d-4*Tgas(i) &
            + 1.105846d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,434) = krate(i,190)*exp(1.251329d0*(lnTgas(i)-1d0) &
            - 3.540927d-3*Tgas(i) &
            + 2.891923d-6*Tgas2(i) &
            - 1.485442d-9*Tgas3(i) &
            ...
            - 5.708806d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,434) = krate(i,190)*exp(2.387615d-1*(lnTgas(i)-1d0) &
            + 3.625165d-5*Tgas(i) &
            - 2.598555d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,435) = krate(i,191)*exp(4.923788d-1*(lnTgas(i)-1d0) &
            - 1.361244d-3*Tgas(i) &
            + 1.043821d-6*Tgas2(i) &
            ...
            - 1.193818d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,435) = krate(i,191)*exp(-2.960452d-2*(lnTgas(i)-1d0) &
            + 1.406042d-4*Tgas(i) &
            - 2.969366d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,436) = krate(i,192)*exp(2.939206d-1*(lnTgas(i)-1d0) &
            + 1.33481d-3*Tgas(i) &
            - 1.609282d-6*Tgas2(i) &
            + 8.51035d-10*Tgas3(i) &
            ...
            - 4.067308d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,436) = krate(i,192)*exp(5.588795d-1*(lnTgas(i)-1d0) &
            - 4.960044d-4*Tgas(i) &
            + 5.86948d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,437) = krate(i,193)*exp(7.24179d-1*(lnTgas(i)-1d0) &
            + 1.976793d-3*Tgas(i) &
            - 2.658776d-6*Tgas2(i) &
            + 1.4598d-9*Tgas3(i) &
            ...
            - 1.09153d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.3d3) then
        krate(i,437) = krate(i,193)*exp(8.647473d-1*(lnTgas(i)-1d0) &
            - 7.578481d-4*Tgas(i) &
            + 1.024685d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,438) = krate(i,194)*exp(1.449668d0*(lnTgas(i)-1d0) &
            + 6.802812d-4*Tgas(i) &
            - 7.335402d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,438) = krate(i,194)*exp(1.698868d0*(lnTgas(i)-1d0) &
            - 5.217185d-4*Tgas(i) &
            + 5.098478d-8*Tgas2(i) &
            - 2.85559d-12*Tgas3(i) &
      ...
      !divided because pseudo-3body
      krate(i,438) = krate(i,438) / ntot(i)
    end do

    !NH -> H + N
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,439) = krate(i,195)*exp(1.50705d0*(lnTgas(i)-1d0) &
            - 1.558979d-4*Tgas(i) &
            + 2.481777d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,439) = krate(i,195)*exp(2.132216d0*(lnTgas(i)-1d0) &
            - 5.774841d-4*Tgas(i) &
            + 5.096031d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,439) = krate(i,439) / ntot(i)
    end do

    !N2O + O -> NO2 + N
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,440) = krate(i,196)*exp(1.018614d0*(lnTgas(i)-1d0) &
            - 4.805419d-3*Tgas(i) &
            + 3.947678d-6*Tgas2(i) &
            - 2.002445d-9*Tgas3(i) &
            ...
            - 2.304025d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,440) = krate(i,196)*exp(-6.601297d-2*(lnTgas(i)-1d0) &
            - 1.262114d-4*Tgas(i) &
            + 2.601039d-9*Tgas2(i) &
            + 1.89495d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,441) = krate(i,197)*exp(2.554078d0*(lnTgas(i)-1d0) &
            - 1.780952d-3*Tgas(i) &
            + 5.731377d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,441) = krate(i,197)*exp(1.426313d0*(lnTgas(i)-1d0) &
            - 3.554992d-4*Tgas(i) &
            + 2.212817d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,441) = krate(i,441) / ntot(i)
    end do

    !HOCO -> OH + CO
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,442) = krate(i,198)*exp(4.676756d0*(lnTgas(i)-1d0) &
            - 5.867759d-3*Tgas(i) &
            + 1.02064d-6*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,442) = krate(i,198)*exp(4.815028d-1*(lnTgas(i)-1d0) &
            - 7.296351d-4*Tgas(i) &
            + 9.880808d-8*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,442) = krate(i,442) / ntot(i)
    end do

    !CO2 + OH -> HOCO + O(3P)
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,443) = krate(i,199)*exp(-2.857682d-1*(lnTgas(i)-1d0) &
            - 5.691425d-4*Tgas(i) &
            + 1.443017d-6*Tgas2(i) &
            ...
            + 3.494167d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,443) = krate(i,199)*exp(4.74109d-1*(lnTgas(i)-1d0) &
            + 2.111259d-5*Tgas(i) &
            - 1.448921d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,444) = krate(i,200)*exp(3.312979d-1*(lnTgas(i)-1d0) &
            - 3.123488d-4*Tgas(i) &
            + 7.879958d-7*Tgas2(i) &
            ...
            + 2.083246d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,444) = krate(i,200)*exp(9.304938d-1*(lnTgas(i)-1d0) &
            - 3.444072d-4*Tgas(i) &
            + 1.717059d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,445) = krate(i,201)*exp(2.20895d-1*(lnTgas(i)-1d0) &
            - 2.622424d-3*Tgas(i) &
            + 2.642832d-6*Tgas2(i) &
            - 1.414461d-9*Tgas3(i) &
            ...
            + 3.808863d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,445) = krate(i,201)*exp(-5.211934d-2*(lnTgas(i)-1d0) &
            + 1.959205d-4*Tgas(i) &
            - 5.248337d-8*Tgas2(i) &
            + 5.72463d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,446) = krate(i,202)*exp(-9.531287d-1*(lnTgas(i)-1d0) &
            + 7.783403d-3*Tgas(i) &
            - 6.214146d-6*Tgas2(i) &
            + 2.802486d-9*Tgas3(i) &
            ...
            + 7.644998d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,446) = krate(i,202)*exp(1.835337d0*(lnTgas(i)-1d0) &
            - 1.313937d-3*Tgas(i) &
            + 1.719255d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,447) = krate(i,203)*exp(-2.383407d0*(lnTgas(i)-1d0) &
            + 5.685426d-3*Tgas(i) &
            - 1.337924d-6*Tgas2(i) &
            ...
            + 8.133056d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,447) = krate(i,203)*exp(2.179989d0*(lnTgas(i)-1d0) &
            - 2.032492d-4*Tgas(i) &
            - 1.884663d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,448) = krate(i,204)*exp(6.936178d-1*(lnTgas(i)-1d0) &
            - 4.120277d-3*Tgas(i) &
            + 4.351638d-6*Tgas2(i) &
            - 2.425376d-9*Tgas3(i) &
            ...
            + 2.085422d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,448) = krate(i,204)*exp(3.361366d-1*(lnTgas(i)-1d0) &
            + 1.751731d-4*Tgas(i) &
            - 3.839046d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,449) = krate(i,205)*exp(3.668817d0*(lnTgas(i)-1d0) &
            - 1.977371d-3*Tgas(i) &
            - 1.401192d-6*Tgas2(i) &
            + 1.243164d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,449) = krate(i,205)*exp(1.097288d0*(lnTgas(i)-1d0) &
            - 9.192171d-4*Tgas(i) &
            + 1.184078d-7*Tgas2(i) &
      ...
      !divided because pseudo-3body
      krate(i,449) = krate(i,449) / ntot(i)
    end do

    !O(3P) + CO2 -> O(1D) + CO2
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,450) = krate(i,206)*exp(-6.683292d-1*(lnTgas(i)-1d0) &
            + 1.639745d-3*Tgas(i) &
            - 1.107235d-6*Tgas2(i) &
            + 5.107031d-10*Tgas3(i) &
            - 1.056415d-13*Tgas4(i) &
            ...
            + 2.564912d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,450) = krate(i,206)*exp(-4.995222d-2*(lnTgas(i)-1d0) &
            + 2.053902d-5*Tgas(i) &
            - 9.749684d-10*Tgas2(i) &
            - 1.828914d-13*Tgas3(i) &
            + 1.389781d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,451) = krate(i,207)*exp(-6.683292d-1*(lnTgas(i)-1d0) &
            + 1.639745d-3*Tgas(i) &
            - 1.107235d-6*Tgas2(i) &
            + 5.107031d-10*Tgas3(i) &
            - 1.056415d-13*Tgas4(i) &
            ...
            + 2.564912d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,451) = krate(i,207)*exp(-4.995222d-2*(lnTgas(i)-1d0) &
            + 2.053902d-5*Tgas(i) &
            - 9.749684d-10*Tgas2(i) &
            - 1.828914d-13*Tgas3(i) &
            + 1.389781d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,452) = krate(i,208)*exp(-6.683292d-1*(lnTgas(i)-1d0) &
            + 1.639745d-3*Tgas(i) &
            - 1.107235d-6*Tgas2(i) &
            + 5.107031d-10*Tgas3(i) &
            - 1.056415d-13*Tgas4(i) &
            ...
            + 2.564912d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,452) = krate(i,208)*exp(-4.995222d-2*(lnTgas(i)-1d0) &
            + 2.053902d-5*Tgas(i) &
            - 9.749684d-10*Tgas2(i) &
            - 1.828914d-13*Tgas3(i) &
            + 1.389781d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,453) = krate(i,209)*exp(3.623198d-1*(lnTgas(i)-1d0) &
            - 3.807928d-3*Tgas(i) &
            + 3.563642d-6*Tgas2(i) &
            - 1.813831d-9*Tgas3(i) &
            + 3.892445d-13*Tgas4(i) &
            ...
            - 1.874704d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,453) = krate(i,209)*exp(-5.943572d-1*(lnTgas(i)-1d0) &
            + 5.195803d-4*Tgas(i) &
            - 5.556105d-8*Tgas2(i) &
            + 3.079467d-12*Tgas3(i) &
            - 5.786477d-17*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,454) = krate(i,210)*exp(2.027211d0*(lnTgas(i)-1d0) &
            - 1.014224d-2*Tgas(i) &
            + 7.769155d-6*Tgas2(i) &
            - 3.549074d-9*Tgas3(i) &
            + 7.005324d-13*Tgas4(i) &
            ...
            - 8.727032d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,454) = krate(i,210)*exp(-9.094383d-1*(lnTgas(i)-1d0) &
            + 4.514574d-4*Tgas(i) &
            - 4.156442d-8*Tgas2(i) &
            + 3.147845d-12*Tgas3(i) &
            - 1.229239d-16*Tgas4(i) &
    ...
    !do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,455) = krate(i,211)*exp(2.73141d0*(lnTgas(i)-1d0) &
    !        - 5.824448d-3*Tgas(i) &
    !        + 2.173293d-6*Tgas2(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,455) = krate(i,211)*exp(-6.202894d-1*(lnTgas(i)-1d0) &
    !        - 3.377647d-4*Tgas(i) &
    !        + 5.702193d-8*Tgas2(i) &
    ...
    !end do
    do i=1,cellsNumber
      krate(i,455) = 1.57d13*(Tgas(i)/298)*exp(-4883/Tgas(i))
    end do
